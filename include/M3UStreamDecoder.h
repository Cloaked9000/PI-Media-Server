...
#ifndef MEDIASERVER_M3USTREAMDECODER_H
#define MEDIASERVER_M3USTREAMDECODER_H


#include <StreamDecoderBase.h>

class M3UStreamDecoder : public StreamDecoderBase
{
public:
    /*!
...
#endif //MEDIASERVER_M3USTREAMDECODER_H
